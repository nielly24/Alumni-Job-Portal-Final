-- First, let's temporarily disable the foreign key constraint to insert dummy data
ALTER TABLE public.job_postings DROP CONSTRAINT IF EXISTS job_postings_user_id_fkey;
